"""Test-only Betclic synthetic fixture parser (``betclic-fixture-bundle-v1``)."""
...
SYNTHETIC_SCHEMA = "betclic-fixture-bundle-v1"


def parse_betclic_synthetic_payloads(
    ...
    *,
    ...
    """Parse one or more sanitized Betclic synthetic fixture payloads (tests only)."""
